...
<html>
    ...
    <body>
        ...
        <div id="show-personne" class="content scaffold-show" role="main">
            ...
            <f:display bean="personne" />
            <g:form resource="${this.personne}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.personne}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
