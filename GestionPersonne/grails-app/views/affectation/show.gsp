...
<html>
    ...
    <body>
        ...
        <div id="show-affectation" class="content scaffold-show" role="main">
            ...
            <f:display bean="affectation" />
            <g:form resource="${this.affectation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.affectation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
