...
<html>
    ...
    <body>
        ...
        <div id="show-formation" class="content scaffold-show" role="main">
            ...
            <f:display bean="formation" />
            <g:form resource="${this.formation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.formation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
